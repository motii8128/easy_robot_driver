...
async fn main()->Result<(), DynError>
{
    ...
    let subscriber_fl = node.create_subscriber::<std_msgs::msg::Float32>("/motor/fl", None)?;
    let subscriber_fr = node.create_subscriber::<std_msgs::msg::Float32>("/motor/fr", None)?;
    let subscriber_rl = node.create_subscriber::<std_msgs::msg::Float32>("/motor/rl", None)?;
    let subscriber_rr = node.create_subscriber::<std_msgs::msg::Float32>("/motor/rr", None)?;
    let subscriber_ex = node.create_subscriber::<std_msgs::msg::Float32>("/motor/ex", None)?;
